...
def check_supported_model_or_raise(
    ...
    return (
        ...
        SUPPORTED_MODEL_KIND[model.config.model_type][features],
    )
...
def main():
    ...
    onnx_inputs, onnx_outputs = export(
        tokenizer, model, onnx_config, args.opset, args.output
    )

    validate_model_outputs(
        onnx_config, tokenizer, model, args.output, onnx_outputs, args.atol
    )
