...
def _monkey_patch_tensor_methods_for_model_recording(model, method_names):
    ...
    for method_name in method_names:
        ...
        setattr(
            torch.Tensor,
            method_name,
            _wrap_method_for_model_recording(model, method_name, cache_name),
        )
...
class HFTracer(Tracer):
    ...
    def record(self, model, input_names, method_names=None):
        ...
        (
            cache_names,
            original_methods,
        ) = _monkey_patch_tensor_methods_for_model_recording(clone, method_names)
