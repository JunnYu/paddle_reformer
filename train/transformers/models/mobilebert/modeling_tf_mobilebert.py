    ...
    def call(
        ...
        **kwargs,
        ...
        prediction_scores = self.predictions(
            sequence_output, training=inputs["training"]
        )

        loss = (
            None
            if inputs["labels"] is None
            else self.compute_loss(inputs["labels"], prediction_scores)
        )
        ...
        **kwargs,
        ...
        next_sentence_loss = (
            ...
            if inputs["next_sentence_label"] is None
                ...
                labels=inputs["next_sentence_label"], logits=seq_relationship_scores
            )
        )
