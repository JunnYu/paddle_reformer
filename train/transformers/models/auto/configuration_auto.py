...
from ..albert.configuration_albert import (
...
from ..big_bird.configuration_big_bird import (
...
from ..blenderbot.configuration_blenderbot import (
...
from ..camembert.configuration_camembert import (
    CAMEMBERT_PRETRAINED_CONFIG_ARCHIVE_MAP,
    CamembertConfig,
)
from ..canine.configuration_canine import (
    CANINE_PRETRAINED_CONFIG_ARCHIVE_MAP,
    CanineConfig,
)
from ..clip.configuration_clip import CLIP_PRETRAINED_CONFIG_ARCHIVE_MAP, CLIPConfig
from ..convbert.configuration_convbert import (
    CONVBERT_PRETRAINED_CONFIG_ARCHIVE_MAP,
    ConvBertConfig,
)
from ..ctrl.configuration_ctrl import CTRL_PRETRAINED_CONFIG_ARCHIVE_MAP, CTRLConfig
from ..deberta.configuration_deberta import (
    DEBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP,
    DebertaConfig,
)
from ..deberta_v2.configuration_deberta_v2 import (
...
from ..openai.configuration_openai import (
    OPENAI_GPT_PRETRAINED_CONFIG_ARCHIVE_MAP,
    OpenAIGPTConfig,
)
from ..pegasus.configuration_pegasus import PegasusConfig
from ..prophetnet.configuration_prophetnet import (
    PROPHETNET_PRETRAINED_CONFIG_ARCHIVE_MAP,
    ProphetNetConfig,
)
from ..rag.configuration_rag import RagConfig
from ..reformer.configuration_reformer import ReformerConfig
from ..retribert.configuration_retribert import (
    RETRIBERT_PRETRAINED_CONFIG_ARCHIVE_MAP,
    RetriBertConfig,
)
from ..roberta.configuration_roberta import (
    ROBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP,
    RobertaConfig,
)
from ..roformer.configuration_roformer import (
...
from ..squeezebert.configuration_squeezebert import (
...
from ..transfo_xl.configuration_transfo_xl import (
    TRANSFO_XL_PRETRAINED_CONFIG_ARCHIVE_MAP,
    TransfoXLConfig,
)
from ..visual_bert.configuration_visual_bert import (
    VISUAL_BERT_PRETRAINED_CONFIG_ARCHIVE_MAP,
    VisualBertConfig,
)
from ..vit.configuration_vit import VIT_PRETRAINED_CONFIG_ARCHIVE_MAP, ViTConfig
from ..wav2vec2.configuration_wav2vec2 import (
...
from ..xlm_roberta.configuration_xlm_roberta import (
