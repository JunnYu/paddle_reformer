        ...
        if self.task is None:
            ...
            if entity_spans is None:
                ...
                assert entities is None or (
                    ...
                    and (len(entities) == 0 or isinstance(entities[0], str))
                ...
                if entities is None:
                    ...
                    first_entity_ids = [
                        self.entity_vocab.get(entity, unk_entity_id)
            ...
            if text_pair is not None:
                if entity_spans_pair is None:
                    ...
                    assert isinstance(entity_spans_pair, list) and (
                        len(entity_spans_pair) == 0
                        or isinstance(entity_spans_pair[0], tuple)
                    ...
                    assert entities_pair is None or (
                        ...
                        and (
                            len(entities_pair) == 0 or isinstance(entities_pair[0], str)
                        )
            ...
            first_entity_ids = [
                self.entity_vocab["[MASK]"],
                self.entity_vocab["[MASK2]"],
            ]
            first_ids, first_entity_token_spans = get_input_ids_and_entity_token_spans(
                text, entity_spans
            )
    ...
    def _pad(
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                if entities_provided:
                    encoded_inputs["entity_ids"] = (
                        encoded_inputs["entity_ids"] + [0] * entity_difference
                    )
                ...
                if return_attention_mask:
                    ...
                    if entities_provided:
                        encoded_inputs["entity_attention_mask"] = [
                            0
                        ] * entity_difference + [1] * len(encoded_inputs["entity_ids"])
                if "token_type_ids" in encoded_inputs:
                    encoded_inputs["token_type_ids"] = [
                        0
