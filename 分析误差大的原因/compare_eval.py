...
def create_inputs(device="cpu"):
    paddle.seed(42)
    pdx = {
        "input_ids": paddle.randint(50, 150, shape=[2, 32]),
        "attention_mask": paddle.randint(1, 2, shape=[2, 32]),
    }
...
if __name__ == "__main__":
    test_cpu("weights/2_layer")
    test_cpu("weights/12_layer")
    test_cpu("weights/random_2_layer")
    test_cpu("weights/random_12_layer")